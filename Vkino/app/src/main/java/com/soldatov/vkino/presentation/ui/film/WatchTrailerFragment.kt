...
class WatchTrailerFragment : Fragment() {
    ...
    private var _binding: FragmentWatchTrailerBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentWatchTrailerBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.takeIf { it.containsKey(IFRAME_TRAILER) }?.apply {
            val iframeLink = "<iframe style=\"transform: translate(-10px, -10px); " +
                    "width: calc(100% + 20px); height: calc(100% + 20px)\" " +
                    "src=\"${getString(IFRAME_TRAILER)}\" frameborder=\"0\" id=\"onik-player\" " +
